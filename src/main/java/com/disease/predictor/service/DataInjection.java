...
public class DataInjection {
    ...
    public ResponseEntity<Object> insertData() throws JsonProcessingException {
        ...
        {
            logger.error("Error to inject first model data :: {}",e.getMessage());
            return new ResponseEntity<>("Error to inject first model data ::"+e.getLocalizedMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }

    private void adduserData() throws CustomException {
        ...
        {
            logger.error("Error to inject user data :: {}",e.getLocalizedMessage());
            throw  new CustomException("Error to inject user data :: ");
        }
    }
    ...
    private void addOneMoreModel(DiseaseMaster diseaseMaster,DiseaseMaster diseaseMasterCVD) throws JsonProcessingException, CustomException {
...
//        diseaseMaster = diseaseMasterRepo.save(diseaseMaster);
        ...
        {
            logger.error("Error to inject second model :: {}",e.getLocalizedMessage());
            throw  new CustomException("Error to inject second model");
        }
